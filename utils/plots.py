...
def plot_labels(labels, save_dir=''):
    ...
    @param labels: 数据集的全部真实框标签  (class_index, class+xywh)
    @param save_dir: 保存路径，一般为run/train/xxx
    """
    # plot dataset labels
    c, b = labels[:, 0], labels[:, 1:].transpose()  # classes, boxes .transpose() 将(, 4) -> (4, )
    ...
    # seaborn correlogram
    # 画出labels的 xywh 各自联合分布直方图 labels_correlogram.jpg
